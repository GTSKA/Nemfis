...
template < typename U > friend void CMatrix_Simplex_2Phases(CMatrix_<T>* mTableau, CMatrix_<T>* objFunction, bool minimize, CARRAY_UINT* vAList, CARRAY_UINT* vInList, CARRAY_UINT* vOutList, UINT* nLastInput, UINT* numSteps, LPSIMPLEX_RESULT res);
